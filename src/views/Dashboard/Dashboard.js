          ...
          <div className="col-lg-3 col-md-6 col-sm-6">
            <div className="card dash-card">
              <div className="stats">
                ...
                <div className="value">
                  <NumberFormat value={contributionsCollection.contributionCalendar.totalContributions} displayType={'text'} thousandSeparator={true} />
                </div>
              </div>
              <hr />
            ...
            <div className="card dash-card">
              <div className="stats">
                ...
                <span className="value">
                  <NumberFormat value={issues.totalCount} displayType={'text'} thousandSeparator={true} />
                </span>
              </div>
              <hr />
              <div className="details">
          ...
          <div className="col-lg-3 col-md-6 col-sm-6">
            <div className="card dash-card">
              <div className="stats">
                ...
                <span className="value">
                  <NumberFormat value={pullRequests.totalCount} displayType={'text'} thousandSeparator={true} />
                </span>
              </div>
              <hr />
              <div className="details">
          ...
          <div className="col-lg-3 col-md-6 col-sm-6">
            <div className="card dash-card">
              <div className="stats">
                ...
                <span className="value">
                  <NumberFormat value={gists.totalCount} displayType={'text'} thousandSeparator={true} />
                </span>
              </div>
              <hr />
              <div className="details">
