      ...
      <div className="repository-content">
        <div className="title-div d-flex align-items-center justify-content-between">
          <div className="col col-md-6">
            <p className="title">Repositories (<NumberFormat value={totalCount} displayType={'text'} thousandSeparator={true} />)</p>
          </div>
                  ...
                  <div className="card repo-card">
                    ...
                    <div className="row repo-stats">
                      <div className="col-2 p-0">
                        ...
                        <NumberFormat value={repo.forks.totalCount} displayType={'text'} thousandSeparator={true} />
                      </div>
                      <div className="col-2 p-0">
                        ...
                        <NumberFormat value={repo.watchers.totalCount} displayType={'text'} thousandSeparator={true} />
                      </div>
                      <div className="col-2 p-0">
                        <svg className="github-icon" height="16" viewBox="0 0 16 16" version="1.1" width="16" aria-hidden="true">
                        ...
                        <NumberFormat value={repo.stargazers.totalCount} displayType={'text'} thousandSeparator={true} />
                      </div>
                      <div className="col-2 p-0">
                        <svg className="github-icon" height="16" viewBox="0 0 16 16" version="1.1" width="16" aria-hidden="true">
                        ...
                        <NumberFormat value={repo.openIssues.totalCount} displayType={'text'} thousandSeparator={true} />
                      </div>
                      <div className="col-2 p-0">
                        <svg className="github-icon" height="16" viewBox="0 0 16 16" version="1.1" width="16" aria-hidden="true">
                        ...
                        <NumberFormat value={repo.openPullRequest.totalCount} displayType={'text'} thousandSeparator={true} />
                      </div>
                    </div>
