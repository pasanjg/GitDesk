...
export default function Profile() {
  ...
  if (loading)
    ...
    const dataWeights = Array.from({ length: 100 }, () => Math.floor(Math.random() * 10) + 1);
    ...
    return (
      <div className="profile-content">
        ...
        <div className="col-12 user-details mt-4">
          ...
          <div className="stats">
            <span className="number font-weight-bold">
              <NumberFormat value={data.viewer.following.totalCount} displayType={'text'} thousandSeparator={true} />
            </span>
            <span>Following</span>
          </div>
          <div className="stats">
            <span className="number font-weight-bold">
              <NumberFormat value={data.viewer.starredRepositories.totalCount} displayType={'text'} thousandSeparator={true} />
            </span>
            <span>Starred</span>
          </div>
          <div className="stats">
